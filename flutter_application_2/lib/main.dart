...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //String name = "ajsdjad";
  List<String> Lista = ["Pepe","Juan","Oliver"];
  Student student = Student(name: "Carlos", enrollment: "20223TN150");
  ...
  void _addStudent(){
    final name = txtNameCtrl.text.trim();
    if(name.isNotEmpty){
      setState(() {
        Lista.add(name);
        txtNameCtrl.clear();
        ...
        Center(
          child: Column(
            children: [
              ...
              Text("Student List: "),
              SizedBox(height: 10),
              ...Lista.map((student) => Text(student)).toList()
            ],
          ),
        ),
      ],
